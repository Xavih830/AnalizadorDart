...
| **08-07-2026** | Xavier, Manuel y Johan | Fase 4: Robustez y GUI | Corrección del direccionamiento de importaciones absolutas en `gui.py` agregando dinámicamente la raíz del proyecto al `sys.path` para posibilitar su ejecución autónoma desde cualquier directorio (incluido `src/`). |
